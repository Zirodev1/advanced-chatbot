...
import PhotoEditorActions from "./PhotoEditorActions/photoeditoractions";
import AudioActions from "./AudioActions";
import PhotoGeneratorActions from "./PhotoGeneratorActions/photogeneratoractions";
import SocialActions from "./SocialActions/socialactions";
import CreateNewAction from "./CreateNewAction/createnewaction";

import { chatActions } from "../../mocks/chats";
import { twMerge } from "tailwind-merge";

const RightSidebar = ({ typeChat, visible, onClick }) => {
    const [search, setSearch] = useState("");
    const [type, setType] = useState("built-in");

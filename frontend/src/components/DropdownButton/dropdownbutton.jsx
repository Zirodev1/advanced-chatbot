...
const DropdownButton = ({item}) => {
  ...
  return item.url ? (
    <Link 
      className='group flex  items-center w-full p-2 rounded-xl text-base-2 font-semibold text-n-s transition-colors hover:bg-n-2 dark:text-n-3 dark:hover:bg-n-6 dark:hover:text-n-1'
